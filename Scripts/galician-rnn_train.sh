...
python ${MODEL}/melody_rnn_train.py --config=basic_rnn --run_dir=${OUTPUT}/RNN/galician-rnn_4/ --sequence_example_file=${INPUT}/sequence_example_train/training_melodies.tfrecord --hparams="batch_size=128,rnn_layer_sizes=[512,512]" --num_training_steps=5000 --num_checkpoints=1000 --summary_frequency=50
